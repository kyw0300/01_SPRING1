...
<main>
	...
	<c:set value="${totalRecord }" var="count"/>
		...
		<div class="row">
				...
				<form action="" method="post">
					<div>
						<div class="text-right">
							<span class="badge bg-secondary">전체 ${count.BCOUNT }건</span>
						</div>
					</div>
							...
							<c:choose>
								...
								<c:otherwise>
									<c:forEach items="${boardList }" var="board">
										<tr onclick="location.href='/board/detail.do?boNo=${board.boNo }'">
											<td>${board.boNo }</td>
											<td>${board.boTitle }</td>
											<td>${board.boDate }</td>
										</tr>
			...
			<div class="col-md-6">
				...
				<form action="" method="post">
					<div>
						<div class="text-right">
							<span class="badge bg-secondary">전체  ${count.NCOUNT }건</span>
						</div>
					</div>
					<div style="padding-top: 20px">
						<table class="table">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<form action="" method="post">
					<div>
						<div class="text-right">
							<span class="badge bg-secondary">전체  ${count.FCOUNT }건</span>
						</div>
					</div>
					<div style="padding-top: 20px">
						<table class="table">
