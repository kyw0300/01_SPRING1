...
public class BookDao {
	...
	public int updateBook(Map<String, Object> map) {
		/*
		 * sqlSessionTemplate객체의 updateBook메소드는 insert 메소드와 사용법이 동일하다.
		 * 첫번째 파라미터는 쿼리 ID, 두번째 파라미터는 쿼리 파라미터이고 반환값은 영향받은 행 수 이다.
		 */
	...
	public int removeBook(Map<String, Object> map) {
		/*
		 * sqlSessionTemplate객체의 removeBook메소드는 update 메소드와 사용법이 동일하다.
		 * 첫번째 파라미터는 쿼리 ID, 두번째 파라미터는 쿼리 파라미터이고 반환값은 영향받은 행 수 이다.
		 */
